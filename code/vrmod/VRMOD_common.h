...
extern cvar_t 		*vr_controller_type;
extern cvar_t		*laserBeamRGBA;
extern cvar_t		*showVirtualKeyboard;
extern cvar_t 		*VR_hide_torso;
extern cvar_t 		*VR_angle_hide_torso;
extern cvar_t      *menu_distance;
extern cvar_t      *vr_righthanded;
extern cvar_t      *vr_weaponPitch;
extern cvar_t      *renderingThirdPerson;
